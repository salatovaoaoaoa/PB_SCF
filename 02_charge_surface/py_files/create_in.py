...
def create_in(
    ...
    full_file_name = f'{file_name_prefix}_Cs_{round(Cs,5)}_s_val_{round(surf_val,2)}_N_{N}_S_{round(S,2)}_theta_{round(theta,2)}_chi_{chi}_alpha_{alpha}.in'
    ...
    folder_name_out = f'surfRange__out_{range_param}_{min_val}_to_{max_val}'
